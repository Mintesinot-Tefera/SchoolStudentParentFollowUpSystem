                ...
                <a class="brand" href="#">&nbsp;&nbsp;&nbsp;<b style="font-family: all;font-size: 25px;"><?php echo Htmlspecialchars($lang['abouttile']); ?></i> </a>
                    <div class="nav-collapse collapse">
                        ...
                        <a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-user icon-large"></i><?php echo $row['firstname']." ".$row['lastname'];  ?> <i class="caret"></i>
                             ...
                             <li class="divider"></li>
                            <li>
                            <a href="change_password_admin.php"><i class="icon-circle"></i><b style="font-family: all;color: black;"> <?php echo Htmlspecialchars($lang['changepassword']); ?> </b> </a>
                            <a tabindex="-1" href="#myModal" data-toggle="modal"><i class="icon-picture"></i> <b style="font-family: all;color: black;"> <?php echo Htmlspecialchars($lang['changeprofile']); ?> </b> </a></li>
