    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <a href="add_class.php" id="print" class="btn btn-success" style="font-family:all;color: white;"><i class="icon-plus">
                </i><b> <?php echo Htmlspecialchars($lang['assignteacher']); ?> </b></a>
                        </diV>  
                <div class="span8" id="">
                     <div class="row-fluid">
                        <!-- block -->
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                              <div class="alert alert-info" style="font-family:all;color: white;"><i class="icon-info-sign"></i><b> <?php echo Htmlspecialchars($lang['TeachertoGrade']); ?></b></div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span16">
                                <form action="delete_usert.php" method="post">
                                    ...
                                    <?php include('modal_delete.php'); ?>
                                        ...
                                        <tbody style="font-family: all;">
                                                    <?php
                                                    $user_query = mysqli_query($link,"select * from teacher_to_class order by grade asc")or die(mysqli_error());
