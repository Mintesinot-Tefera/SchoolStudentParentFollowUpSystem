                ...
                <form method="post" action="view_attendance.php">
                  ...
                  $user_query = mysqli_query($link,"select * from student_to_parent where stuff_id = '$teacher'")or die(mysqli_error()); 
                      ...
                      while ($row1 = mysqli_fetch_array($user_query)) {
                           ...
                           $Today = date('y:m:d');
                          $user_query1 = mysqli_query($link,"select * from attendance where id = '$id'
                        ...
                        <div class="controls">      
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button name="insert" class="btn btn-info" style="color: blue;font-family: all;"><i class="icon-plus-sign" ></i><b> Back </b></button>
                                          </div>
                                        </div></center>
