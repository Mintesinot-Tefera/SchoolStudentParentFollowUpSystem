         ...
         <div class="pull-right"> 
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="alert alert-info"  style="color: 0000;font-family: all;"><i class="icon-info-sign"></i>  Student ID  </div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                    <form method="post" class="form-horizontal" autocomplete="off" action="view_report_card1.php">
                  <strong><b><b><h4 style="color: black;font-family: all;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><strong>  <?php echo Htmlspecialchars($lang['select_semester']); ?> </strong></b>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </b></b></strong></h4><hr>
                  ...
                  $query = mysqli_query($link,"select * from student_to_parent where stuff_id = '$teacher'")
                       or die(mysqli_error());  
                    ...
                    echo "<option value='". $row1['stud_id'] ."' style = 'font-family:all;font-size16px;color:black;'>".$row1['stud_id']."</option>" ; 
                      ...
                      <div class="control-group">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button name="select" class="btn btn-info" style="color: black;font-family: all;">
                          <i class="icon-plus-sign"></i><b>  <?php echo Htmlspecialchars($lang['select']); ?> </b></button>
                                          </div>
                                        </div>
                                </form>
                              </div>
