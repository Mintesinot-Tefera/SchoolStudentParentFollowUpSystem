...
<body>
     ...
     <div class="pull-right">
			<a href="javascript:Clickheretoprint()" id="print" class="btn btn-success"><i class="icon-print"></i> Print </a>
						</diV> 
   ...
   <?php $query1= mysqli_query($link," select * from school_year")
      ...
      <div id="print_content">     
       ...
       <div id="certbody" style="background-image: url(bgimag.png); background-repeat:no-repeat; background-position:100% 100%; ">
		...
		<!--   <div>
    <div class="sideb" ><img src="..//css/<?php // echo $row['location']; ?>" height="120px" width="120px"  ></div>  </div>-->
            ...
            <div class="bodya" style="float:left;">	
		     ...
		     <thead style="color: black;font-family: all;">
		     	...
		     	<?php
                  ...
                  $user_query = mysqli_query($link,"select * from reportcard where stud_id = '$id' ")
                  or die(mysql_error());
          ...
          &nbsp;<span style="border-bottom:1px  dotted black; font-family:courier new; font-style:italic; color:maroon;"></span><br>
	        ...
	        $query= mysqli_query($link,"select * from reportcard1 where stud_id = '$id'")or die(mysqli_error());
								$row = mysqli_fetch_array($query);
