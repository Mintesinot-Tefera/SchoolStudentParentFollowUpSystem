            ...
            <div class="row-fluid">
                ...
                <div class="span8" id="">  
                   ...
                   $query = mysqli_query($link,"select * from teachers where stuff_id = '$teacher'")
                    ...
                    $query = mysqli_query($link,"select * from students where stud_id = '$id' ")or die(mysqli_error());
                ...
                elseif ($current < $start) {
                    ...
                    elseif ($current > $end) {
                     ...
                     $user_query = mysqli_query($link,"select * from student_to_parent where stuff_id = '$teacher'")or die(mysqli_error());
                      ...
                      $user_query = mysqli_query($link,"select * from assessment11 where Stud_Id = '$id'")or die(mysqli_error());
