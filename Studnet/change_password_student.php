...
<?php include('..//Language/lang.php'); ?>
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				<?php include('sidebar_dashboard_student.php'); ?>
                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
					     ...
					     <ul class="breadcrumb">
								...
								<li><a href="#"><b style="font-family: all;color: black"><?php echo Htmlspecialchars($lang['changepassword']); ?></b></a><span class="divider">/</span></li>
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
  								<div class="alert alert-info" style="font-family: all;"><i class="icon-info-sign"></i><b> <?php echo Htmlspecialchars($lang['Please_Fill']); ?> </b></div>
								<?php
								...
								?>								
								    ...
								    <form  method="post" id="change_password" class="form-horizontal">
										<div class="control-group">
											<label class="control-label" for="inputEmail" style="font-family: all;color: black;"><b> <?php echo Htmlspecialchars($lang['Current_Password']); ?>:</b></label>
											<div class="controls">
										...
										<div class="control-group">
											<label class="control-label" for="inputPassword" style="font-family: all;color: black;"><b> <?php echo Htmlspecialchars($lang['new']); ?> :</b></label>
											<div class="controls">
										...
										<div class="control-group">
											<label class="control-label" for="inputPassword" style="font-family: all;color: black;"><b> <?php echo Htmlspecialchars($lang['re']); ?></b></label>
											<div class="controls">
										...
										<div class="control-group">
											<div class="controls">
											<button type="submit" class="btn btn-info" style="font-family: all;color: black;"><i class="icon-save"></i><b> <?php echo Htmlspecialchars($lang['Changeadmin']); ?> </b></button>
											</div>
										</div>
									</form>
