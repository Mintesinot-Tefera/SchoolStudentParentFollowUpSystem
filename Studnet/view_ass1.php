        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span8" id="">  
                    ...
                    $query = mysqli_query($link,"select * from students where stud_id = '$teacher' ")or die(mysqli_error());
                 ...
                 $row12 = mysqli_fetch_array($query111);
                  ...
                  $current= date('Y-m-d'); 
                      ...
                      window.location = "view_assesment.php"; 
                         </script>
                          <?php
                               }
                    ...
                    elseif ($current > $end) {
                      ...
                      $user_query = mysqli_query($link,"select * from assessment11 where Stud_Id = '$teacher'")or die(mysqli_error());
