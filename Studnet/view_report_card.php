...
<body>
     ...
     <div class="pull-right">
      ...
      if ($grade == 10 || $grade == 12) { 
      	     ?>
      	     <script>
      	     //	alert('They have reportcard ');
      	     	window.location = "view_report_card2.php";
      	     </script>
      	     <?php
              }
      ...
      <div id="print_content">     
       ...
       <div id="certbody" style="background-image: url(bgimag.png); background-repeat:no-repeat; background-position:100% 100%; ">  
          ...
          <center>  <p style="color:black"><b style="font-family: all;font-size: 15px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo Htmlspecialchars($lang['Southern']); ?></b></p>
			<p style="color:black"><b style="font-family: all;font-size: 16px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Kambata Tambaro Zone Durame General Senior Secondary School</b></p>
           <p style="color:black"><b style="font-family: all;font-size: 16px;">በካምባታ ዞን ዱራሜ አጠቃላይ  የመጀመርያ  ሁለተኛ ደረጃ  ትምህርት ቤት  <b>
           </p> </center> <br>
   ...
   <?php $query1= mysqli_query($link," select * from school_year")
          ...
          <thead style="color: black;font-family: all;"><br>
		     ...
		     <thead style="color: black;font-family: all;">
		     	...
		     	<th>I</th>
		     	<th>II</th>
		     	<th><?php echo Htmlspecialchars($lang['Average']); ?></th>
		     </thead>   	
		     	<?php
                  ...
                  $user_query = mysqli_query($link,"select * from reportcard where stud_id = '$teacher' ")
                  or die(mysqli_error());
		     	...
		     	<tbody style="color: black;font-family: all;">
		     		...
		     		<td><?php echo $row['amharic2']; ?></td>
		     		<td><?php echo $row['amharic3']; ?></td>
		     	</tbody>
		        <tbody style="color: black;font-family: all;">
		     		<td>English</td>
		     		<td><?php echo $row['english1']; ?></td>
		     		<td><?php echo $row['english2']; ?></td>
		     		<td><?php echo $row['english3']; ?></td>
		     	</tbody>
		     	<tbody style="color: black;font-family: all;">
		     		<td>Maths</td>
		     		<td><?php echo $row['maths1']; ?></td>
		     		<td><?php echo $row['maths2']; ?></td>
		     		<td><?php echo $row['maths3']; ?></td>
		     	</tbody>
		     	<tbody style="color: black;font-family: all;">
		     		<td>Physics</td>
		     		<td><?php echo $row['physics1']; ?></td>
		     		<td><?php echo $row['physics2']; ?></td>
		     		<td><?php echo $row['physics3']; ?></td>
		     	</tbody>
		     	<tbody style="color: black;font-family: all;">
		     		<td>Biology</td>
		     		<td><?php echo $row['biology1']; ?></td>
		     		<td><?php echo $row['biology2']; ?></td>
		     		<td><?php echo $row['biology3']; ?></td>
		     	</tbody>
		     	<tbody style="color: black;font-family: all;">
		     		<td>Chemistry</td>
		     		<td><?php echo $row['chemistry1']; ?></td>
		     		<td><?php echo $row['chemistry2']; ?></td>
		     		<td><?php echo $row['chemistry3']; ?></td>
		     	</tbody>
		     	<tbody style="color: black;font-family: all;">
		     		<td>Geography</td>
		     		<td><?php echo $row['geography1']; ?></td>
		     		<td><?php echo $row['geography2']; ?></td>
		     		<td><?php echo $row['geography3']; ?></td>
		     	</tbody>
		     	<tbody style="color: black;font-family: all;">
		     		<td>History</td>
		     		<td><?php echo $row['history1']; ?></td>
		     		<td><?php echo $row['history2']; ?></td>
		     		<td><?php echo $row['history3']; ?></td>
		     	</tbody>
		     	<tbody style="color: black;font-family: all;">
		     		<td>Civics</td>
		     		<td><?php echo $row['civics1']; ?></td>
		     		<td><?php echo $row['civics2']; ?></td>
		     		<td><?php echo $row['civics3']; ?></td>
		     	</tbody>
		     	<tbody style="color: black;font-family: all;">
		     		<td>HPE</td>
		     		<td><?php echo $row['hpe1']; ?></td>
		     		<td><?php echo $row['hpe2']; ?></td>
		     		<td><?php echo $row['hpe3']; ?></td>
		     	</tbody>
		     	<tbody style="color: black;font-family: all;">
		     		<td>IT</td>
		     	...
		     	<tbody style="color: black;font-family: all;">
		     		...
		     		<td><?php echo $row['avarage2']; ?></td>
		     		<td><?php echo $row['avarage3']; ?></td>
		     	</tbody>
		     	<tbody style="color: black;font-family: all;">
		     		<td><?php echo Htmlspecialchars($lang['Rank']); ?></td>
		     		<td><?php echo $row['rank1']; ?></td>
		     		<td><?php echo $row['rank2']; ?></td>
		     		<td><?php echo $row['rank3']; ?></td>
		     	</tbody>		     			     			     			     			     
		     	<tbody style="color: black;font-family: all;">
		     		<td><?php echo Htmlspecialchars($lang['Conduct']); ?></td>
		     		<td><?php echo $row['conduct']; ?></td>
		     		<td><?php echo $row['conduct']; ?></td>
		     		<td><?php echo $row['conduct']; ?></td>
		     	</tbody>
		     	<tbody style="color: black;font-family: all;">
		     		<td><?php echo Htmlspecialchars($lang['Absence_Day']); ?></td>
		     		<td><?php echo $row['absence_day']; ?></td>
		     		<td><?php echo $row['absence_day']; ?></td>
		     		<td><?php echo $row['absence_day']; ?></td>
		     	</tbody>
		     	<tbody style="color: black;font-family: all;">
		     		<td><?php echo Htmlspecialchars($lang['Remark']); ?></td>
		     		<td><?php echo '----'; ?></td>
		     		<td><?php echo $row['Remark']; ?></td>
		     		<td><?php echo $row['Remark']; ?></td>
		     	</tbody>
		        <tbody style="color: black;font-family: all;">
		     		<td><?php echo Htmlspecialchars($lang['Pomoted_To']); ?></td>
		     		<td><?php echo '----'; ?></td>
		     		<td><?php echo $row['Promotted_To']; ?></td>
		     		<td><?php echo $row['Promotted_To']; ?></td>
		     	</tbody>	
		     </table>    
          &nbsp;<span style="border-bottom:1px  dotted black; font-family:courier new; font-style:italic; color:maroon;"></span><br>
            ...
            Teacher Name: &nbsp;&nbsp;<span style="border-bottom:1px dotted black; font-family:courier new; font-style:italic; color:maroon;"><?php echo $row['teacher_name']?></span><br>
			...
			<?php $query= mysqli_query($link,"select * from users where type = 'director'")or die(mysqli_error());
								$row = mysqli_fetch_array($query);
						?>
			Director Name: &nbsp;&nbsp;<span style="border-bottom:1px  dotted black; font-family:courier new; font-style:italic; color:maroon;"><?php echo $row['firstname'] ?></span>
			...
			<?php $query= mysqli_query($link,"select date from users where type = 'home_room_teacher'")or die(mysqli_error());
				$row = mysqli_fetch_array($query);
						?>
			Date received: &nbsp;&nbsp;&nbsp;<span style="border-bottom:1px  dotted black; font-family:courier new; font-style:italic; color:maroon;"><?php echo $row['date']; ?> </span>&nbsp;&nbsp;&nbsp;<br>
		</ol>
            </div>
            </div>
        </div>
