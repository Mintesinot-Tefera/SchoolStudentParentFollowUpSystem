 ...
 ?>
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				<?php include('viewcomment_sidebar.php'); ?>
                <div class="span8" id="">
                     <div class="row-fluid">
                        <!-- block -->
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span16">
								<form action="delete_users1.php" method="post">
                       ...
                       $uname = $teacher1." ".$teacher2;
                             // $uname = $row1['firstname'];
                    $sql = mysqli_query($link,"SELECT *From teacher_to_course where teacher = '$uname' ");
                    ...
                    $user_query1 = mysqli_query($link,"select * from students where grade = '$grade'
                            ...
                            while ($row1 = mysqli_fetch_array($user_query1)){
                            	$id = $row1['stud_id'];
							$user_query = mysqli_query($link,"select * from comments where stud_id = '$id' AND viewer = 'Subject Teacher'")or die(mysqli_error());
