    ...
    <?php include('sidebar_addass.php'); ?> 
        <div class="span6" id="adduser"> 
         ...
         <div class="pull-right">  
                   ...
                   <h3 style="font-family: all;font-size: 22px; color: black;"> <b><STRONG> <?php echo Htmlspecialchars($lang['First_Semester_Student_Assesment_Form']); ?>  </STRONG></b></h3><hr>
                    <form method="post" class="form-horizontal" action="ass.php">
                ...
                <?php 
                  ...
                  $teacher = $teacher1." ".$teacher2;
                    ...
                    <label class="control-label" for="inputPassword" style="font-family: all;font-size: 17px; color: black;"><strong><b> <?php echo Htmlspecialchars($lang['Grade']); ?> </b></strong></label>
                                          <div class="controls">
                             <select class="chzn-select" name="grade" id="focusedInput" type="text" placeholder =" <?php echo Htmlspecialchars($lang['select']); ?>" required style="font-family: all;font-size: 16px; color: black;">
                    ...
                    echo "<option value='". $row['ass_name'] ."' style = 'font-family:all;font-size16px;color:black;'>".$row['ass_name'] ."</option>" ;
                      ...
                      <div class="control-group">
                        <div class="controls">      
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button name="add" class="btn btn-info" style="font-family: all;color: black;"><i class="icon-plus-sign "></i><strong> <?php echo Htmlspecialchars($lang['Addadmin']); ?> </strong></button>
                                    </div>
                                  </div>
