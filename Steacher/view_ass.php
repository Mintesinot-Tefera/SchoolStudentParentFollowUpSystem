                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                             ...
                             <b style="color: white;font-family: all;font-size: 16px;"><?php echo Htmlspecialchars($lang['Grade']); ?> <?php echo $grade; ?> <?php echo Htmlspecialchars($lang['Students']); ?>   <?php echo $subject; ?> Assesment List </b>  </div>
                            </div>
