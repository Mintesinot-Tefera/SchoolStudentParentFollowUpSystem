...
<?php $get_id = $_GET['id']; ?>
    ...
    <?php include('navbar.php'); ?>
        ...
        <?php include('edit_user_forma.php'); ?>           
        </div>
                  <?php 
                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                             ...
                             <b style="color: white;font-family: all;font-size: 16px;">Grade <?php echo $grade; ?>  Students  <?php echo $subject; ?> Result </b>  </div>
                            </div>
                ...
                <form action="delete_users2.php" method="post">
                  ...
                  <?php include('modal_delete.php'); ?>
                    ...
                    <tbody style="font-family: all;color: black;">
                                                <?php 
                         $user_query = mysqli_query($link,"select * from assessment where grade
