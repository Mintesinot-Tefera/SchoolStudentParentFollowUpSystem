   ...
   if (isset($_POST['add'])){ 
              ...
              ?>
                        <div class="row-fluid">
                            ...
                            <div class="alert alert-info"><i class="icon-info-sign"></i><b style="color: white;font-family: all;font-size: 18px;"> Grade <?php echo "$grade";  ?> <?php echo Htmlspecialchars($lang['Students_Result_Form']); ?>  </b></div>
                            </div>
                            ...
                            <div class="block-content collapse in">
                                <div class="span10">
                <form method="post" action="record_ass1.php" autocomplete="off">
                    ...
                    elseif ($current > $end) {
                      ?>
                       ...
                       <?php
                          ...
                          ?>
                        <tr>
                        <td><input type="text" name='id[]' value="<?php echo $row['stud_id']; ?>" readonly  style="font-family: all;color: black;width: 80px;"></td>
