...
<?php $get_id = $_GET['id']; ?>
    ...
    <?php include('navbar.php'); ?>
        <div class="container-fluid">
            <div class="row-fluid">
        <?php include('sidebar_viewass.php'); ?>
                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                             ...
                             <b style="color: white;font-family: all;font-size: 16px;"> <?php echo Htmlspecialchars($lang['Grade']); ?>  <?php echo $grade; ?> <?php echo Htmlspecialchars($lang['student']); ?> <?php echo $subject; ?> <?php echo Htmlspecialchars($lang['Assesment_List']); ?>  </b>  </div>
                            </div>
                ...
                <form action="delete_users.php" method="post">
                  ...
                  <?php include('modal_delete.php'); ?>
                    ...
                    <tbody style="font-family: all;color: black;">
                                                <?php 
                          $user_query = mysqli_query($link,"select * from assessment1 where grade
                      ...
                      <input id="optionsCheckbox" class="uniform_on" name="selector[]" type="checkbox" value="<?php echo $id; ?>">
                          ...
                          <td><?php echo $row['Ass_Type']; ?> </td>
                          <td><?php echo $row['ass_name']; ?> </td>
                          <td><?php echo $row['Max_Mark']; ?> </td>
                          <td><?php echo $row['date']; ?> </td>
                        <td width="40">
                        <a href="edit_user.php<?php echo '?id='.$id; ?>"  data-toggle="modal" class="btn btn-success"><i class="icon-pencil"></i></a>
                        </td>
                        </tr>
                        <?php } ?>
                    </tbody>
