                    ...
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                      ...
                      <?php echo Htmlspecialchars($lang['HOME']); ?> 
                        ...
                        <li>
                         ...
                         <li> 
                            <a href="view_ass.php"style="font-family: all;font-size: 17px;"><i class="icon-chevron-right"></i><i class="icon-book"></i><b><strong><?php echo Htmlspecialchars($lang['View_Assesment']); ?> </strong></strong></b></a>  
                        </li>                     
                         <li>
                        ...
                        <li>
                            <a href="addass1.php"style="font-family: all;font-size: 17px;"><i class="icon-chevron-right"></i><i class="icon-file"></i><b><strong><?php echo Htmlspecialchars($lang['View_Results']); ?></strong></b></a>  
                        </li>                                                              
                        <li>
