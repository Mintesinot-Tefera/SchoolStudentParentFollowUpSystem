    ...
    $(function () {
        $("#new_password").bind("keyup", function () {
								...
								?>								
								   ...
								   <form  method="post" id="change_password" class="form-horizontal">
										<div class="control-group">
											<label class="control-label" for="inputEmail" style="font-family: all;color: black;"><b> Current Password :</b></label>
											<div class="controls">
										...
										<div class="control-group">
											<label class="control-label" for="inputPassword" style="font-family: all;color: black;"><b> Re-type Password :</b></label>
											<div class="controls">
										...
										<div class="control-group">
											<div class="controls">
											<button type="submit" class="btn btn-info" style="font-family: all;color: black;"><i class="icon-save"></i><b> Save </b></button>
											</div>
										</div>
									</form>
			...
			jQuery("#change_password").submit(function(e){
					...
					$.ajax({
						type: "POST",
						url: "update_password_officer.php",
						data: formData,
