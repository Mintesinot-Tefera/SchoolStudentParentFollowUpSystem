    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                </i><b><?php echo Htmlspecialchars($lang['Add_Course']); ?> </b></a>
                        </diV>  
                <div class="span8" id="">
                     <div class="row-fluid">
                        <!-- block -->
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                              <div class="alert alert-info" style="font-family:all;color: white;"><i class="icon-info-sign"></i><b><?php echo Htmlspecialchars($lang['Courses_List']); ?>  </b></div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span16">
                                <form action="delete_usersc.php" method="post">
                                    ...
                                    <?php include('modal_delete.php'); ?>
                                        ...
                                        <tbody style="color: black;font-family: all;">
                                                    <?php
                                                    $user_query = mysqli_query($link,"select * from courses order by name asc ")or die(mysqli_error());
