					...
					<div class="modal-footer">
					<button class="btn" data-dismiss="modal" aria-hidden="true"><i class="icon-remove icon-large"></i> <?php echo Htmlspecialchars($lang['Yes']); ?></button>
					<button name="delete_teacher" class="btn btn-danger"><i class="icon-check icon-large"></i> <?php echo Htmlspecialchars($lang['Yes']); ?></button>
					</div>
					</div>
					...
					<div class="modal-footer">
					<button class="btn" data-dismiss="modal" aria-hidden="true"><i class="icon-remove icon-large"></i> <?php echo Htmlspecialchars($lang['Delete_Content']); ?></button>
