                   ...
                   <br><br>
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                              ...
                              <div class="controls">
											 <select class="" name="course" id="focusedInput" type="text" placeholder ="-select-" required style="font-family:all;color: black;" pattern="[A-Za-z]{1}" title="the name must four letter or greate !!" >
                           <option></option>
                           <option style="font-family: all;font-size: 16px; color: black;">
                               <?php
                              $grade1 = $_SESSION['grade'];
                    $sql = mysqli_query($link,"SELECT *From subjects where grade = '9' or grade = '10'
                            order by id asc ");
...
if (isset($_POST['save'])){
  ...
  $name = $_POST['course'];
   ...
   $query = mysqli_query($link,"select * from courses where grade = '$grade1' AND name = '$name' ")
    or die(mysqli_error());
...
mysqli_query($link,"insert into courses (grade,name,type,Date) 
  values('$grade1','$name','',NOW())")or die(mysqli_error());
