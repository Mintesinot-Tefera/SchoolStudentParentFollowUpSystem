    <div class="navbar navbar-fixed-top navbar-inverse">
                    ...
                    <div class="nav-collapse collapse"> 
						...
						?> 
                            <li class="dropdown">
							 ...
							 <li class="divider"></li>
                            <li>
                           <a href="change_password_officer.php"><i class="icon-circle"></i><b 
                            ...
                            <li>
                            <a href="home.php?lang=en"><i class="icon-circle"></i><b style="font-family: all;color: black;"> <?php echo Htmlspecialchars($lang['English']); ?></b> </a>
                            </li>
                            <li>
                            <a href="home.php?lang=it"><i class="icon-circle"></i><b style="font-family: all;color: black;"><?php echo Htmlspecialchars($lang['አማርኛ']); ?> </b> </a>
                             </li>
        ...
        <?php include('profile_modal_officer.php'); ?>