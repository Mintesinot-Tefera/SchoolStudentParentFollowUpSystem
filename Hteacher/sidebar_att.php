                    ...
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        <li> <a href="teacher_index.php" style="font-size: 17px;font-family: all;"><i class="icon-chevron-right"></i><i class="icon-home" ></i><b><strong>
                         <?php echo Htmlspecialchars($lang['home']); ?> 
						               ...
						               <li>
                            <a href="record_stud.php"style="font-family: all;font-size: 17px;"><i class="icon-chevron-right"></i><i class="icon-user"></i><b><strong><?php echo Htmlspecialchars($lang['Students']); ?> </strong></b></a>  
                        </li> 
                           <li class="active">
