    ...
    $(function () {
        $("#new_password").bind("keyup", function () {
                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
					     ...
					     <ul class="breadcrumb">
								...
								<li><a href="#"><b style="font-family: all;color: black;font-style: normal;font-size: 18px;"><?php echo Htmlspecialchars($lang['Change_Password']); ?> </b></a><span class="divider">/</span></li>
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								?>								
								    ...
								    <form  method="post" id="change_password" autocomplete="off" class="form-horizontal" >
										<div class="control-group">
											<label class="control-label" for="inputEmail" style="font-family: all;color: black;"><b>Current Password</b> 
											 </label>
											<div class="controls">
										...
										<div class="control-group">
											<label class="control-label" for="inputPassword" style="font-family: all;color: black;"><b>New Password</b> </label>
											<div class="controls">
										...
										<div class="control-group">
											<label class="control-label" for="inputPassword" style="font-family: all;color: black;"><b>Re-type Password
											</b></label>
											<div class="controls">
			...
			jQuery("#change_password").submit(function(e){
					...
					$.ajax({
						type: "POST",
						url: "update_password_home_teacher.php",
						data: formData,
						success: function(html){
					
						$.jGrowl("Your password is successfully change", { header: 'Change Password Success' });
						var delay = 2000;
							setTimeout(function(){ window.location = 'teacher_index.php'  }, delay);  
						}	
					});
					}
				});
