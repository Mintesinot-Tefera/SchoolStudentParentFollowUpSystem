                ...
                <div class="span9" id="content"> 
                     <div class="row-fluid">
                        <!-- breadcrumb -->  
                         <ul class="breadcrumb">  
                        <?php
                        $school_year_query = mysqli_query($link,"select * from school_year order by school_year DESC")or die(mysql_error());
                 ...
                 $query = mysqli_query($link,"select * from users where user_id = '$session_id'")
                  ...
                  $type = $row1['type'];
                    ...
                    font-weight: normal;font-size: 20px;color: black;">You are <?php
                   echo $teacher; ?> and signed as a <?php echo $type;?></p>
                    </div>
                    <?php
                    }
                    ?>
