            ...
            $query111 = mysqli_query($link,"SELECT * FROM time1") or die(mysqli_error());
                 $row = mysqli_fetch_array($query111);
                  ...
                  $current= date('Y-m-d'); 
                     ...
                     $query = mysqli_query($link,"select * from students where stud_id = '$id1' AND grade = '$grade' AND section = '$section' ")
                     or die(mysqli_error());
                    ...
                    elseif ($current > $end) {
                     ...
                     ?>
                   <h3  style="color: black;font-family: all;"> <b><STRONG>!!!<?php echo $row['grade'] ?> <?php echo Htmlspecialchars($lang['Student_Report_card_Form']); ?></STRONG></b></h3><hr>
                    <form method="post" class="form-horizontal" action="report_card10.php">
                  ...
                  <label class="control-label" for="inputPassword"  style="color: black;font-family: all;">
                    <b><strong><?php echo Htmlspecialchars($lang['School_Name']); ?>  </strong></b> </label>
                        <div class="controls">
                        <input class="input focused" name="name" id="focusedInput" type="text" placeholder = " <?php echo Htmlspecialchars($lang['Stud_Id']); ?>" required value="Durame General Senior Secondary School" 
                    ...
                    <b><strong><?php echo Htmlspecialchars($lang['Stud_FName']); ?></strong></b> </label>
                     ...
                     <div class="control-group">
                    <label class="control-label" for="inputPassword" style="color: black;font-family: all;"><b> <?php echo Htmlspecialchars($lang['Sex']); ?> </b></label>
                        <div class="controls">
                      ...
                      <div class="control-group">
                    <label class="control-label" for="inputPassword" style="color: black;font-family: all;"><b><?php echo Htmlspecialchars($lang['Age']); ?>  :</b></label>
                        <div class="controls">
                    ...
                    $querys = mysqli_query($link,"select * from school_year")
                     ...
                     ?>                                                               
                      <div class="control-group">
                      <label class="control-label" for="inputPassword" style="color: black;font-family: all;"><b>Year :</b></label>
                                <div class="controls">
                                <input class="input focused" name="year" id="focusedInput" type="text" placeholder = "acadamic year" value="<?php echo $row['school_year'] ?>" readonly required style="color: black;font-family: all;" readonly>
                                        </div>
                                        </div>
               ...
               <?php      
                    $user_query1 = mysqli_query($link,"select Max_Mark,Result from assessment where 
                      Stud_Id = '$id1' AND Subject = 'Amharic' ")or die(mysqli_error());
                          $total = 0;
                          $maxm = 0;
               ...
               <?php 
              $user_query2 = mysqli_query($link,"select Max_Mark,Result from assessment where 
                      Stud_Id = '$id1' AND Subject = 'English' ")or die(mysqli_error());
                          $total = 0;
                          $maxm = 0;
               ...
               <?php 
              $user_query3 = mysqli_query($link,"select Max_Mark,Result from assessment where 
                      Stud_Id = '$id1' AND Subject = 'Maths' ")or die(mysqli_error());
                          $total = 0;
                          $maxm = 0;
               ...
               <?php 
              $user_query4 = mysqli_query($link,"select Max_Mark,Result from assessment where 
                      Stud_Id = '$id1' AND Subject = 'Physics' ")or die(mysqli_error());
                          $total = 0;
                          $maxm = 0;
               ...
               <?php 
              $user_query5 = mysqli_query($link,"select Max_Mark,Result from assessment where 
                      Stud_Id = '$id1' AND Subject = 'Biology' ")or die(mysql_error());
                          $total = 0;
                          $maxm = 0;
               ...
               <?php 
              $user_query6 = mysqli_query($link,"select Max_Mark,Result from assessment where 
                      Stud_Id = '$id1' AND Subject = 'Chemistry' ")or die(mysqli_error());
                          $total = 0;
                          $maxm = 0;
               ...
               <?php 
              $user_query7 = mysqli_query($link,"select Max_Mark,Result from assessment where 
                      Stud_Id = '$id1' AND Subject = 'Geography' ")or die(mysqli_error());
                          $total = 0;
                          $maxm = 0;
               ...
               <?php 
              $user_query8 = mysqli_query($link,"select Max_Mark,Result from assessment where 
                      Stud_Id = '$id1' AND Subject = 'History' ")or die(mysql_error());
                          $total = 0;
                          $maxm = 0;
               ...
               <?php 
              $user_query9 = mysqli_query($link,"select Max_Mark,Result from assessment where 
                      Stud_Id = '$id1' AND Subject = 'Civics' ")or die(mysqli_error());
                          $total = 0;
                          $maxm = 0;
               ...
               <?php 
              $user_query10 = mysqli_query($link,"select Max_Mark,Result from assessment where 
                      Stud_Id = '$id1' AND Subject = 'HPE' ")or die(mysqli_error());
                          $total = 0;
                          $maxm = 0;
               ...
               <?php 
              $user_query10 = mysqli_query($link,"select Max_Mark,Result from assessment where 
                      Stud_Id = '$id1' AND Subject = 'IT' ")or die(mysqli_error());
                          $total = 0;
                          $maxm = 0;
                         while ($row1 = mysqli_fetch_array($user_query10)) {
                    $max = $row1['Max_Mark'];     
                    ...
                    ?>
                      ...
                      <div class="control-group">
                        <div class="controls">      
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button name="add" class="btn btn-info" style="color: black;font-family: all;"><i class="icon-plus-sign"></i><?php echo Htmlspecialchars($lang['Addadmin']); ?></button>
                                          </div>
                                        </div>
                                        <?php
                                      }
