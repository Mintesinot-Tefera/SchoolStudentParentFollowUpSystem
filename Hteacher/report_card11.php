         ...
         <div class="pull-right">   
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12"> 
                   <h3  style="color: black;font-family: all;"> <b><STRONG>!!! 
                   <?php echo Htmlspecialchars($lang['Student_Report_card_Form']); ?> </STRONG></b></h3><hr>
                    <form method="post" class="form-horizontal" action="report_card12.php">
                      <?php 
