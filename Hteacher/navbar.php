    <div class="navbar navbar-fixed-top navbar-inverse"> 
           <div class="navbar-inner">
               <div class="container-fluid">
                   ...
                   <a class="brand" href="#">&nbsp;&nbsp;&nbsp;<b style="font-family: all;font-size: 25px;"> <?php echo Htmlspecialchars($lang['Welcome_To']); ?></b>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i style="font-family: all;font-size: 25px;"><?php echo Htmlspecialchars($lang['Parent_Student_Follow-Up_System']); ?></i> </a>
                    ...
                    <div class="nav-collapse collapse">
						...
						?>
                            <li class="dropdown">
							 ...
							 <li class="divider"></li>
                            <li>
                           <a href="change_password_Hteacher.php"><i class="icon-circle"></i><b style="font-family: all;color: black;"> <?php echo Htmlspecialchars($lang['Change_Password']); ?>  </b> </a>
        ...
        <?php include('profile_modal_hteacher.php'); ?> 